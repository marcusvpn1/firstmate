...
`bin/fm-bootstrap.sh` enforces the quota-axi floor, owned beside the constants in [`bin/fm-bootstrap.sh`](../../bin/fm-bootstrap.sh), through `bin/fm-quota-axi-lib.sh`.
