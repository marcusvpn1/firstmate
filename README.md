...
- **Task shapes** - ship tasks deliver authorized changes; scout, spec, and plan tasks leave standalone reports when the intake contract warrants separate research.
