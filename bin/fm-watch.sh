...
# is the single owner of per-harness sources, source attribution, and the
# narrowly scoped Grok and experimental-AGY rendered fallbacks.
...
# consumed only by the Grok- or AGY-scoped fallback inside the contract.
